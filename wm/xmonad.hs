...
myStartupHook        = do
    ...
    spawn "firefox -p azazo -new-instance"
    spawn "firefox -p helgi -new-instance"
    spawn "firefox -p helgim -new-instance"
    spawn "/usr/libexec/mate-settings-daemon"
    spawn "unclutter"
    spawn "seapplet"
    spawn "nm-applet"
    spawn "firewall-applet"
    spawn "/home/helgi/.bin/kb_toggle.sh"
